	...
	public static void main(String [] args) {
				...
				numToCheck += increment)
		{
			...
			for(int t = 0; t < trials; t++){
				BasicDocument bd = new BasicDocument(string);
				double fs = bd.getFleschScore();
			}
			long basicEndTime = System.nanoTime();
			double endTime = (double)(basicEndTime - basicStartTime) / 100000000.0;
			System.out.print(endTime + "\t");

			long efficientStartTime = System.nanoTime();
			for(int t = 0; t < trials; t++){
				EfficientDocument ed = new EfficientDocument(string);
				double fs = ed.getFleschScore();
			}
			long efficientEndTime = System.nanoTime();
			double effEndTime = (double)(efficientEndTime - efficientStartTime) / 100000000.0;
			System.out.println(effEndTime);
		}
