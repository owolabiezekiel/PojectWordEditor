...
public class EfficientDocument extends Document {
	...
	private void processText()
	{
		...
		for (String word : tokens){
			...
			if (i == tokenS){
				//System.out.printf("Entered this loop when %d was equal to %d", i, tokenS);
				//System.out.println("this is the last word: " + word);
		...
		//System.out.printf("Overall, I got %d syllable(s), %d word(s) and %d sentence(s)", numSyllables, numWords, numSentences);
