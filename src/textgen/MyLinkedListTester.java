...
public class MyLinkedListTester {
	...
	public void testAddEnd() {
		try {
			longerList.add(null);
			fail("Null Value Error");
		} catch (NullPointerException e) {
		}

		assertEquals("Add to end: ", true, list1.add(20));
		assertEquals("Add to end: ", true, shortList.add("J"));
	}
	...
	public void testSet() {
		...
		try {
			shortList.set(LONG_LIST_LENGTH, "A");
			fail("Check out of bounds");
		} catch (IndexOutOfBoundsException e) {
		}
		...
		assertEquals("Set: Check D is correct", "D", shortList.set(2, "D"));
	}
